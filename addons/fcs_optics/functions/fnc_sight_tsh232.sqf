...
/*
    fn_MKK_SIGHT_TSH_2_32
    T-55 sight simulation
    by Westalgie
...
["mkk_t55_sight_handler", "onEachFrame", {
    ...
    if(time > _time)then
    {
        ...
        if(_mode!=_mode_old)then
        {
            ...
            if(  ctrlText ( (uiNamespace getVariable "MKK_T55_Ctrl")  displayCtrl 1000) != "MKK_SIGHT_TSH_2_32" ) exitWith {
                // remove event handlers & deinitalize variables
                (findDisplay 46) displayRemoveEventHandler ["KeyDown", uiNamespace getVariable "mkk_tsh_2_32_eh"];
                (findDisplay 46) displayRemoveEventHandler ["KeyUp", uiNamespace getVariable "mkk_tsh_2_32_eh_up"];
                ["mkk_t55_sight_handler", "onEachFrame"] call BIS_fnc_removeStackedEventHandler;
            ...
            switch(_mode)do{
                ...
                case "NARROW" : {
                    ...
                    _bar ctrlSetText QPATHTOF(data\reticles\WST_tsh_2_32_x8_bar_ca.paa);
                    _sight ctrlCommit 0.001;
                    _bar ctrlCommit 0.001;
                };
            };
