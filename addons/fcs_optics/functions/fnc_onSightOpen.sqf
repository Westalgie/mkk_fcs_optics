...
switch _type do {
    ...
    case QGVAR(RscWeaponM60A1_FCS): {
        GVAR(opticPFH) = [FUNC(applySight), 0.1, [_display, vehicle player unitTurret player, M60A1_MAGS_RETICLES]] call CBA_fnc_addPerFrameHandler;
        TRACE_2("Added optics PFH",_type,GVAR(opticPFH));
    };
