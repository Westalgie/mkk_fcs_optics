...
def check_stringtable(filepath):
    ...
    # Verify only packages that matches PROJECT_NAME
    if (root.get("name") != PROJECT_NAME and root.get("name") != PROJECT_NAME.lower):
        print("Skip '{}' project.".format(root.get("name")))
        return errors
